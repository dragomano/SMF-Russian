...
VALUES ('cust_tg', '{telegram}', '{telegram_desc}', 'text', 32, '', 1, 'nohtml', 0, 1, 0, 'forumprofile', 0, 1, 0, 0, '', '<a href="//t.me/{INPUT}" target="_blank" rel="noopener" title="Telegram - {INPUT}"><img src="{DEFAULT_IMAGES_URL}/telegram-icon.png" alt="Telegram - {INPUT}"></a>', 1),
